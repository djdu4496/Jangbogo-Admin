...
public class ProductServiceImpl implements ProductService {
    ...
    public int getSearchResultCnt(SearchCondition sc) {
        return productDao.getSearchResultCnt(sc);
    }
    ...
    // 매개변수 : SearchCondition sc
    @Override
    public List<ProductDto> getPendingSearchSelectPage(SearchCondition sc) {
        return productDao.getPendingSearchSelectPage(sc);
    }
    ...
    // 매개변수 : SearchCondition sc
    @Override
    public int getPendingSearchResultCnt(SearchCondition sc) {
        return productDao.getPendingSearchResultCnt(sc);
    }
    ...
    @Override
    public int updateProductRegState(Map<Integer, Integer> pathVarsMap) {
        return productDao.updateProductRegState(pathVarsMap);
    }

    @Override
    public List<ProductFile> selectPdFiles(Integer prod_idx) throws Exception {
        return productDao.selectPdFiles(prod_idx);
    }
